...
namespace Matri.Data.Impl
{
    public class ServiceRepository : ServiceBase, IServiceRepository
    {
        ...
        public async Task<bool> UploadProfilePhoto(MultipartFormDataContent formData, string uri)
        {
            var client = CreateHttpClientForPhotoUpload();
            HttpResponseMessage httpResponse = await client.PostAsync(uri, formData);//""
