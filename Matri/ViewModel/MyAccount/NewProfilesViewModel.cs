...
{
    public partial class NewProfilesViewModel : CommunityToolkit.Mvvm.ComponentModel.ObservableObject, IQueryAttributable
    {
        ...
        public NewProfilesViewModel(IServiceManager serviceManager)
        {
        ...
        {
            if (obj != null && obj is NewProfilesViewModel)
            {
                var item = (NewProfilesViewModel)obj;
