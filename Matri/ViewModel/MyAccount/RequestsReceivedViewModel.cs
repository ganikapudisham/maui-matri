...
{
    public partial class RequestsReceivedViewModel : CommunityToolkit.Mvvm.ComponentModel.ObservableObject
    {
        ...
        public async Task<bool> GetProfiles(int pageNumber, int pageSize)
        {
            ...
            try
            {
                ...
                var dbProfilesWithPaging = await _serviceManager.GetRequestReceived(token, pageNumber, pageSize);
