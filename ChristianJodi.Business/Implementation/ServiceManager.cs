...
namespace ChristianJodi.Business.Impl
{
    public class ServiceManager : IServiceManager
    {
        ...
        public async Task<App> GetAppDetails(Guid sessiontoken)
        {
            var url = Constants.API_URL_GetAppDetails; //"app";
            return await _serviceRepository.GetAsync<App>(sessiontoken.ToString(), url);
        }
